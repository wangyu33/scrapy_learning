...
def download(url):
    #User-Agent 格式  Mozilla/5.0 (平台) 引擎版本 浏览器版本号
    #常用user-Agent   https://www.cnblogs.com/zrmw/p/9332801.html
    # pcUserAgent = {
    ...
    request.add_header("Connection","keep-alive") #add_header  修改header
    data = urllib.request.urlopen(request)
    print(data.code)
    print(data.read())

url = 'https://www.feiniaomy.com/post/429.html'
download(url)
